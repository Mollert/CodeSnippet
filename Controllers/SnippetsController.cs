...
namespace SnippetApp.Controllers
{
    public class SnippetsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,Description,ProgrammingLanguage,CodeSnippet")] Snippet snippet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Title,Description,ProgrammingLanguage,CodeSnippet")] Snippet snippet)
        {
            if (id != snippet.ID)
            {
                return NotFound();
